...
-- allinea descrizione_raw alla colonna già esistente descrizione
UPDATE public.greenhouse_products_normalized
SET descrizione_raw = descrizione
...
DROP TRIGGER IF EXISTS trg_products_normalized_touch
ON public.greenhouse_products_normalized;
