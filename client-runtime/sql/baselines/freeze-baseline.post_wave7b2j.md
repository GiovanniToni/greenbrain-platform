...
### WAVE-7B.2-J VALIDATION
- client-runtime planner current-week micro-wave applied successfully via 12_schema_7b2j.sql
- validated endpoint:
  - /api/v1/planner/current-week = 200
- local runtime object added:
  - core_planner__get_current_week52()
- implemented as local safe stub to preserve planner backend contract without full planner dependency chain
- regression checks remained green
- live gb_v2 stack untouched
- shadow stack untouched
