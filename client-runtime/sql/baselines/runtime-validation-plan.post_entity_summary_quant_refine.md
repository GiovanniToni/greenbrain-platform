...
4. entity-summary ✅ non-empty tree validated; current totals still zero-like; next: decide whether endpoint is tree-only or must expose real quantitative totals
5. dashboard-kpis
