...
|----------|--------|------|-------------|----------------|----------|----------|
| /analytics/entity-summary | REAL / STRUCTURE-VALIDATED / QUANT-ZERO | CORE | products + components chain | HIGH | P1 | decide whether quantitative totals are required and, if yes, implement them honestly |
