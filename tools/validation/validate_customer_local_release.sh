...
grep_required "SOURCE_DB_IMPORT_BATCH_SIZE" "$PKG/base/apps/source-db-importer/import_sales_raw.py"
grep_required "SOURCE_DB_IMPORT_MAX_BATCHES" "$PKG/base/apps/source-db-importer/import_sales_raw.py"
grep_required "SELECT TOP .*safe_batch_size" "$PKG/base/apps/source-db-importer/import_sales_raw.py"
grep_required "ORDER BY {progressivo_col}" "$PKG/base/apps/source-db-importer/import_sales_raw.py"
grep_required "Max batches reached" "$PKG/base/apps/source-db-importer/import_sales_raw.py"
grep_required "ON CONFLICT .*source_client_code, progressivo.* DO NOTHING" "$PKG/base/apps/source-db-importer/import_sales_raw.py"
...
require_file "$PKG/base/scripts/fix-source-db-log-permissions.sh"
require_file "$PKG/base/scripts/prepare-source-db-importer-image.sh"
require_file "$PKG/base/scripts/promote-source-db-raw.sh"
require_file "$PKG/base/scripts/check-source-db-data-readiness.sh"
require_file "$PKG/base/client-runtime/sql/init/28_source_db_promote_to_greenhouse_raw.sql"
grep_required "SOURCE_DB_LOG_PERMISSIONS_OK" "$PKG/base/scripts/fix-source-db-log-permissions.sh"
grep_required "SOURCE_DB_IMPORTER_LOCAL_IMAGE_RETAG_OK" "$PKG/base/scripts/prepare-source-db-importer-image.sh"
grep_required "pull never" "$PKG/base/scripts/test-source-db-technical.sh"
grep_required "pull never" "$PKG/base/scripts/import-source-db-once.sh"
grep_required "promote_source_import_sales_raw_to_greenhouse_raw" "$PKG/base/client-runtime/sql/init/28_source_db_promote_to_greenhouse_raw.sql"
grep_required "SOURCE_DB_RAW_PROMOTION_OK" "$PKG/base/scripts/promote-source-db-raw.sh"
grep_required "PRODUCT_NORMALIZATION_REQUIRED" "$PKG/base/scripts/check-source-db-data-readiness.sh"
grep_required "STEP 0b source db raw promotion" "$PKG/base/orchestration/jobs/runtime/run_daily_sequence.sh"
...
grep_required "SOURCE_DB_IMPORT_BATCH_SIZE" "$ZPKG/base/apps/source-db-importer/import_sales_raw.py"
grep_required "SOURCE_DB_IMPORT_MAX_BATCHES" "$ZPKG/base/apps/source-db-importer/import_sales_raw.py"
grep_required "SELECT TOP .*safe_batch_size" "$ZPKG/base/apps/source-db-importer/import_sales_raw.py"
grep_required "ORDER BY {progressivo_col}" "$ZPKG/base/apps/source-db-importer/import_sales_raw.py"
grep_required "Max batches reached" "$ZPKG/base/apps/source-db-importer/import_sales_raw.py"
grep_required "ON CONFLICT .*source_client_code, progressivo.* DO NOTHING" "$ZPKG/base/apps/source-db-importer/import_sales_raw.py"
...
require_file "$ZPKG/base/scripts/fix-source-db-log-permissions.sh"
require_file "$ZPKG/base/scripts/prepare-source-db-importer-image.sh"
require_file "$ZPKG/base/scripts/promote-source-db-raw.sh"
require_file "$ZPKG/base/scripts/check-source-db-data-readiness.sh"
require_file "$ZPKG/base/client-runtime/sql/init/28_source_db_promote_to_greenhouse_raw.sql"
grep_required "SOURCE_DB_LOG_PERMISSIONS_OK" "$ZPKG/base/scripts/fix-source-db-log-permissions.sh"
grep_required "SOURCE_DB_IMPORTER_LOCAL_IMAGE_RETAG_OK" "$ZPKG/base/scripts/prepare-source-db-importer-image.sh"
grep_required "pull never" "$ZPKG/base/scripts/test-source-db-technical.sh"
grep_required "pull never" "$ZPKG/base/scripts/import-source-db-once.sh"
grep_required "promote_source_import_sales_raw_to_greenhouse_raw" "$ZPKG/base/client-runtime/sql/init/28_source_db_promote_to_greenhouse_raw.sql"
grep_required "SOURCE_DB_RAW_PROMOTION_OK" "$ZPKG/base/scripts/promote-source-db-raw.sh"
grep_required "PRODUCT_NORMALIZATION_REQUIRED" "$ZPKG/base/scripts/check-source-db-data-readiness.sh"
grep_required "STEP 0b source db raw promotion" "$ZPKG/base/orchestration/jobs/runtime/run_daily_sequence.sh"
